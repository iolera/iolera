...
Such dataset creation is valuable for a number of reasons. It:

- Enables a new class of content creation to replace traditional jobs eaten by AI.
...
- Whatever else that can be made public
